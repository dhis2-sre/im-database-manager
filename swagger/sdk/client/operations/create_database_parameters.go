...
type CreateDatabaseParams struct {
	...
	*/
	Body *models.CreateDatabaseRequest
...
func (o *CreateDatabaseParams) WithBody(body *models.CreateDatabaseRequest) *CreateDatabaseParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create database params
func (o *CreateDatabaseParams) SetBody(body *models.CreateDatabaseRequest) {
	o.Body = body
}
